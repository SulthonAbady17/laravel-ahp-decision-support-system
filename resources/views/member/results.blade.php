            ...
            @if ($period)
                ...
                <div class="space-y-4">
                    @forelse ($results as $result)
                        ...
                        @endif
                    @empty
                        <p class="text-on-surface dark:text-on-surface-dark text-center">Hasil perhitungan belum tersedia.
                        </p>
                    @endforelse
                </div>
            @else
                <div class="py-8 text-center">
                    ...
                    <p class="text-on-surface dark:text-on-surface-dark mt-2">
                        Saat ini belum ada hasil penilaian yang dipublikasikan.
                    </p>
                </div>
            @endif
